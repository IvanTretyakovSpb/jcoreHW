...
public class Application {
    public static void main(String[] args) {
        ...
        final Object[][] data = {
                ...
                {shop.customers.get(0), shop.products.get(0), 5, Celebration.NONE},
                ...
                // correct data for male on March 8
                {shop.customers.get(2), shop.products.get(2), 4, Celebration.FEB_23},
                // correct data on Ney Year
                {shop.customers.get(3), shop.products.get(3), 10, Celebration.NEW_YEAR},
                // incorrect amount -7
                {shop.customers.get(1), shop.products.get(4), -7, Celebration.NONE},
                // incorrect amount 333
                {shop.customers.get(2), shop.products.get(1), 333, Celebration.NONE},
                // incorrect product
                {shop.customers.get(3), new Product("Car", 100_000), 2, Celebration.NONE},
                // incorrect customer
